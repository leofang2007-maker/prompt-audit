...
- 🔄 **[More client adapters](https://github.com/leofang2007-maker/prompt-audit/issues/5)** — **Qoder** (✅ verified in a real deployment) + **Claude Code** (⚠️ built to the documented managed-hook API, not yet live-verified — [`clients/claude-code/`](clients/claude-code/), [spec 0005](docs/specs/0005-claude-code-adapter.md)); Cursor / Copilot / Codex next. Adapter [verification status](clients/README.md).
