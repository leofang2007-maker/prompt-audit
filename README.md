...
- 🔄 **[More client adapters](https://github.com/leofang2007-maker/prompt-audit/issues/5)** — **Claude Code shipped** (enterprise-enforced via managed hooks — [`clients/claude-code/`](clients/claude-code/), [spec 0005](docs/specs/0005-claude-code-adapter.md)); Qoder ships today; Cursor / Copilot / Codex next.
